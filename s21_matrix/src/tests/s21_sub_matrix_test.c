...
Suite* sub_matrix_suite() {
  Suite* suite = suite_create("SUB MATRIX TEST");
  ...
  tcase_add_test(tc, sub_matrix_12);
  tcase_add_test(tc, sub_matrix_13);
  tcase_add_test(tc, sub_matrix_14);
  tcase_add_test(tc, sub_matrix_15);
  tcase_add_test(tc, sub_matrix_16);
  tcase_add_test(tc, sub_matrix_17);
